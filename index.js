...
function isEvenNumber(num) {
  ...
  // Використовуємо оператор залишку від ділення на 2 для перевірки парності числа
  return num % 2 === 0;
}
...
function isPositiveNumber(num) {
  return num > 0; // Перевіряємо, чи число num більше 0
...
function isEmptyString(str) {
  return str === '';// Перевіряємо, чи рядок str дорівнює пустому рядку ('')
...
function checkDataType(value) {
  let type = typeof value; // Отримуємо тип значення value за допомогою оператора typeof
...
function getDayOfWeek(dayNumber) {
  ...
  switch (dayNumber) {   // Використовуємо оператор switch для знаходження назви дня тижня залежно від dayNumber
    ...
    case 1:   // Якщо dayNumber = 1, то day = "Понеділок"
      day = "Понеділок";
      break;
    case 2:  // Якщо dayNumber = 2, то day = "Вівторок"
      day = "Вівторок";
      break;
    case 3:   // Якщо dayNumber = 3, то day = "Середа"
      day = "Середа";
      break;
    case 4:   // Якщо dayNumber = 4, то day = "Четвер"
      day = "Четвер";
      break;
    case 5:   // Якщо dayNumber = 5, то day = "П'ятниця"
      day = "П'ятниця";
      break;
    case 6:   // Якщо dayNumber = 6, то day = "Субота"
      day = "Субота";
      break;
    case 7:   // Якщо dayNumber = 7, то day = "Неділя"
      day = "Неділя";
      break;
    default:   // Якщо значення dayNumber не співпадає з жодним з випадків, то day = "Невірний номер дня"
...
function getVariableType(variable) {
  ...
  // Встановлюємо відповідне повідомлення залежно від отриманого типу
    // Використовуємо тернарний оператор для коротшого коду
    // Повертаємо встановлене повідомлення як результат функції
    return typeof variable === "number" // Якщо тип змінної - number, то повідомлення = "Це число"
    ? "Це число"
    : typeof variable === "string" // Якщо тип змінної - string, то повідомлення = "Це рядок"
    ? "Це рядок"
    : typeof variable === "boolean" // Якщо тип змінної - boolean, то повідомлення = "Це булеве значення"
    ? "Це булеве значення"// В іншому випадку (якщо тип змінної не входить у попередні категорії), то повідомлення = "Це інший тип"
    : "Це інший тип";
}
...
function memoizedArea() {
  ...
  return function(side) { 
    ...
    if (side === prevSide) {
      ...
      // Зберігаємо аргумент та результат для майбутнього використання
...
var squareArea = memoizedArea(); //Створюємо змінну squareArea якій присвоємо результат виконання функції memoizedArea
...
let createCompose = compose(increment, double);// Створюємо змінну createCompose якій присвоємо результат виконання функції compose з аргументами increment та double
